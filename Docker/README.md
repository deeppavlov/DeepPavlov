...
### Start container
Don't forget to change host mapping path for container `/data` dir in `docker-compose.yml` from `~/data` to correct.
...
* GET `/update/wikidata` - download new wikidata, parse it to .pickle files, update model
