...
PARAMS = {
    ...
    "classifiers": {
        ...
        ("classifiers/sentiment_imdb_bert.json", "classifiers", ('IP',)): [ONE_ARGUMENT_INFER_CHECK],
        ("classifiers/sentiment_imdb_conv_bert.json", "classifiers", ('IP',)): [ONE_ARGUMENT_INFER_CHECK]
    },
    "snips": {
