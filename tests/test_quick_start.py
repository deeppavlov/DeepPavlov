...
PARAMS = {
    ...
    "squad": {
        ...
        ("squad/squad_zh_bert.json", "squad_zh_bert", ALL_MODES): [TWO_ARGUMENTS_INFER_CHECK],
        ("squad/squad_zh_zh_bert.json", "squad_zh_zh_bert", ALL_MODES): [TWO_ARGUMENTS_INFER_CHECK]
    },
    "seq2seq_go_bot": {
