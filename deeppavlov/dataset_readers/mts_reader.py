...
class MtsReader(DatasetReader):
    ...
    def read(self, data_path: str, **kwargs) -> Dict[str, List[Tuple[List[str], int]]]:
        ...
        train_fname = data_path / 'mts.csv'
        valid_fname = data_path / 'mts.csv'
        test_fname = data_path / 'mts.csv'
        dataset["train"] = self._preprocess_data_valid_test(train_fname)
