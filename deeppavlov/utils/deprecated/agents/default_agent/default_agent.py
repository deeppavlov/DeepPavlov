...
from deeppavlov.utils.deprecated.agent import Agent, Filter, Processor
from deeppavlov.utils.deprecated.agents.filters import TransparentFilter
...
class DefaultAgent(Agent):
    ...
    You can refer to :class:`deeppavlov.utils.deprecated.skill.Skill`, :class:`deeppavlov.utils.deprecated.agent.Filter`,
    :class:`deeppavlov.utils.deprecated.agent.Processor` base classes to get more info.
