...
1. (_optional, but recommended_) pretrained named entity recognition model (NER) 
   * config [`deeppavlov/config_examples/ner/config.json`](../../config_examples/ner/config.json) is recommended
2. (_optional, but recommended_) pretrained intents classifier model 
   * config [`deeppavlov/config_examples/intents/config_dstc2.json`](../../config_examples/intents/config_dstc2.json) is recommended
...
4. pretrained goal-oriented bot model itself 
   * config [`deeppavlov/config_examples/go_bot/config.json`](../../config_examples/go_bot/config.json) is recommended
...
For a working exemplary config see [`deeeppavlov/config_examples/go_bot/config.json`](../../config_examples/go_bot/config.json) (model without embeddings).

A minimal model without `slot_filler`, `intent_classifier` and `embedder` is configured in [`deeeppavlov/config_examples/go_bot/config_minimal.json`](../../config_examples/go_bot/config_minimal.json).

A full model (with fasttext embeddings) configuration is in [`deeeppavlov/config_examples/go_bot/config_all.json`](../../config_examples/go_bot/config_all.json)
...
See [`deeeppavlov/config_examples/go_bot/config.json`](../../config_examples/go_bot/config.json) for details.
...
|----------------------------------------------|-------------|-------------------------|----------------------|
|basic bot			                               | [`config_minimal.json`](../../config_examples/go_bot/config_minimal.json) | 0.5271             |     0.4853           |
|bot with slot filler & fasttext embeddings    |        |      0.5305             |     0.5147           |
|bot with slot filler & intents                | [`config.json`](../../config_examples/go_bot/config.json)                 |   **0.5436**         |     **0.5261**       |
|bot with slot filler & intents & embeddings   | [`config_all.json`](../../config_examples/go_bot/config_all.json)         |      0.5307             |     0.5145           |
