...
in `config_examples/intents/config_dstc2.json` and then run
```
python deep.py interact config_examples/intents/config_dstc2.json
```
or
```
python deep.py interactbot config_examples/intents/config_dstc2_infer.json
```
...
To train model again or with other parameters on DSTC 2 data
 the only actions are to set parameter `train_now` to `true` in `config_examples/intents/config_dstc2.json`,
...
```
python deep.py train config_examples/intents/config_dstc2.json
```
...
* set parameter `train_now` to `true` in `config_examples/intents/config_snips.json`,
...
```
python deep.py train config_examples/intents/config_snips.json
```
