...
def ngramize(items: List[str], doc: str, ngram_range=(1, 1)) -> Generator[List[str], Any, None]:
    """
    ...
    filtered_ngrams = [ngram for ngram in formatted_ngrams if (ngram in doc or ngram in doc_lower)]

    yield filtered_ngrams
