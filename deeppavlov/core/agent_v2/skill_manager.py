...
class SkillManager:
    ...
    def __init__(self, response_selector, rest_caller: RestCaller, skills_selector=None):
    ...
    def __call__(self, state):
        ...
        skill_responses = self.rest_caller(state, active_skill_names, active_skill_urls)
