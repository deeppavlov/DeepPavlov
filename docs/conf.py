...
latex_documents = [
    (master_doc, 'DeepPavlov.tex', 'DeepPavlov Documentation',
     'Neural Networks and Deep Learning lab, MIPT', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'DeepPavlov', 'DeepPavlov Documentation',
     author, 'DeepPavlov', 'An open source library for building end-to-end dialog systems and training chatbots.',
     'Miscellaneous'),
]
