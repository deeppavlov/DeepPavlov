...
autodoc_mock_imports = ['aiml', 'bert_dp', 'fastText', 'fasttext', 'gensim', 'kenlm', 'lxml', 'nemo', 'nemo_asr',
                        'nemo_tts', 'nltk', 'rasa', 'russian_tagsets', 'sacremoses', 'sortedcontainers', 'spacy',
                        'tensorflow', 'tensorflow_hub', 'torch', 'transformers']
