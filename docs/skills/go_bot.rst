...
+================+======+===========================================+======================================================================+===============+===========+===============+
| `DSTC 2`_ [*]_ | En   | basic bot                                 | :config:`gobot_dstc2_minimal.json <go_bot/gobot_dstc2_minimal.json>` | Turn Accuracy | 0.380     | 400 Mb        |
+                +      +-------------------------------------------+----------------------------------------------------------------------+               +-----------+---------------+
|                |      | bot with slot filler                      | :config:`gobot_dstc2.json <go_bot/gobot_dstc2.json>`                 |               | 0.511     | 400 Mb        |
+                +      +-------------------------------------------+----------------------------------------------------------------------+               +-----------+---------------+
|                |      | bot with slot filler & intents            |                                                                      |               | 0.524     | --            |
+                +      +-------------------------------------------+----------------------------------------------------------------------+               +-----------+---------------+
|                |      | bot with slot filler, intents & attention | :config:`gobot_dstc2_best.json <go_bot/gobot_dstc2_best.json>`       |               | **0.555** | 8.5 Gb        |
+----------------+      +-------------------------------------------+----------------------------------------------------------------------+               +-----------+---------------+
