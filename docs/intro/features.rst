...
.. table::
   ...
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+-------+-------+-----------+
   | `Ubuntu v2`_      | :config:`ranking_ubuntu_v2_mt_word2vec_dam_transformer_interact <ranking/ranking_ubuntu_v2_mt_word2vec_dam_transformer_interact.json>` |   73.12   | 73.18 | 86.28 | 97.23 |  1646 Mb  |
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+-------+-------+-----------+
