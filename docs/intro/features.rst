...
.. table::
   ...
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+-------+-------+-----------+
   | `Ubuntu v2`_      | :config:`ranking_ubuntu_v2_mt_word2vec_dam_transformer_interact <ranking/ranking_ubuntu_v2_mt_word2vec_dam_transformer_interact.json>` |   74.20   | 74.14 | 86.56 | 97.31 |  1646 Mb  |
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+-------+-------+-----------+
   | `Ubuntu v2`_      | :config:`ranking_ubuntu_v2_mt_word2vec_dam_interact <ranking/ranking_ubuntu_v2_mt_word2vec_dam_interact.json>`                         |   71.01   | 71.46 | 83.74 | 96.23 |  1645 Mb  |
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+---------------+-----------+
   | `Ubuntu v2`_      | :config:`ranking_ubuntu_v2_mt_word2vec_smn_interact <ranking/ranking_ubuntu_v2_mt_word2vec_smn_interact.json>`                         |   67.08   | 66.45 | 80.63 | 95.22 |  1609 Mb  |
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+---------------+-----------+
   ...
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+---------------+-----------+
   | `Ubuntu v1`_      | :config:`ranking_ubuntu_v1_mt_word2vec_dam_transformer_interact <ranking/ranking_ubuntu_v1_mt_word2vec_dam_transformer_interact.json>` |   -       | 79.29 | 89.12 | 97.42 |  1628 Mb  |
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+-------+-------+-----------+
   | `Ubuntu v1`_      | :config:`ranking_ubuntu_v1_mt_word2vec_smn_interact <ranking/ranking_ubuntu_v1_mt_word2vec_smn_interact.json>`                         |   -       | 73.52 | 85.60 | 96.28 |  1591 Mb  |
   +-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------+-------+---------------+-----------+
